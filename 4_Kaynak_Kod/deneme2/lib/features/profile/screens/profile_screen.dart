            ...
            child: Column(
              children: [
                _buildSection(
                  ...
                  title: 'Hakkımda',
                  actionButton: isMyProfile ? IconButton(icon: const Icon(Icons.edit_outlined), onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EditProfileScreen()))) : null,
                  child: Text(
      ...
      child: Column(
        children: [
          CircleAvatar(
            ...
            backgroundImage: user.profilePictureUrl != null ? NetworkImage('http://10.0.2.2:8000/${user.profilePictureUrl!}') : null,
